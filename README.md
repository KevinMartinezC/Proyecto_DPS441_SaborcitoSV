...
## Nota: 👀
Este proyecto esta siendo desarrollado en expo dev, aqui puede visualizarlo 
👉🏻 https://snack.expo.dev/@kevin_martinezdev/github.com-kevinmartinezc-proyecto_dps441_saborcitosv para que tenga un correcto funcionamiento sugirimos ejecutarlo en su dispositio movil por medio del codigoQr para que tenga una mejor experiencia con el Mapa o si desea correrlo en el emulador que brinda expo dev, tiene que ser en la versión 42.
